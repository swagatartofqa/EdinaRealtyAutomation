...
//		//Initialize Variable(s)
//		String[] dataTablePathArray;
//		dataTablePathArray = dataTablePath.split("\\");
//		dataTablePathArray = dataTablePath.split("/");
//		
//		//
//		dataTablePath = "";
//		
//		//
//		for (int i = 0; i < dataTablePathArray.length; i++) {
//			dataTablePath += dataTablePathArray[i] + File.separator;
//		}
//		
//		//
//		dataTablePath = dataTablePath.substring(0, dataTablePath.length()-1);
