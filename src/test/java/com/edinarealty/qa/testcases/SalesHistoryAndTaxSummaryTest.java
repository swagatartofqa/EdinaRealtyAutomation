...
public class SalesHistoryAndTaxSummaryTest extends TestBase {

    //Define Variable(s)
    SoftAssert checkpoint;

    //Constructor
    public SalesHistoryAndTaxSummaryTest() {
        super();
    }
    ...
    public void SalesHistoryAndTax(String active, String reportTitle, String website, String accountType, String userid, String password, String multiFactorAuthentication, String expectedSuccessOrFailure, String expectedLoginName, String signout, String propertyState,String propertyNameValue,  String finalResult, String dataRow) {
...
//			eDriver.manage().deleteAllCookies();
            ...
            searchPageMethods.verifySaleHistoryAndTaxSummaryIsDisplayed(propertyState,propertyNameValue);
